...
#if !defined (SELECT_VECS) || defined (HAVE_bfd_elf64_ia64_freebsd_vec)

{ "ia64*-*-freebsd*", NULL },{ "ia64*-*-kfreebsd*-gnu",
&bfd_elf64_ia64_freebsd_vec },
#endif
...
{ "ia64*-*-netbsd*", NULL },{ "ia64*-*-linux-*", NULL },{ "ia64*-*-elf*",
