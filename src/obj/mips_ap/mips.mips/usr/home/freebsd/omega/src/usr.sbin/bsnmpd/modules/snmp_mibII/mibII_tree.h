...
int	op_begemot_mibII(struct snmp_context *, struct snmp_value *, u_int, u_int, enum snmp_op);
# define LEAF_begemotIfMaxspeed 1
# define LEAF_begemotIfPoll 2
# define LEAF_begemotIfForcePoll 3
# define LEAF_begemotIfDataPoll 4

#ifdef SNMPTREE_TYPES

#endif /* SNMPTREE_TYPES */

#define mibII_CTREE_SIZE 146
