...
extern char _binary_urtwn_rtl8192cfwT_fw_start[], _binary_urtwn_rtl8192cfwT_fw_end[];
...
static moduledata_t urtwn_rtl8192cfwT_fw_mod = {
        "urtwn_rtl8192cfwT_fw",
        urtwn_rtl8192cfwT_fw_modevent,
        0
};
DECLARE_MODULE(urtwn_rtl8192cfwT_fw, urtwn_rtl8192cfwT_fw_mod, SI_SUB_DRIVERS, SI_ORDER_FIRST);
MODULE_VERSION(urtwn_rtl8192cfwT_fw, 1);
MODULE_DEPEND(urtwn_rtl8192cfwT_fw, firmware, 1, 1, 1);
