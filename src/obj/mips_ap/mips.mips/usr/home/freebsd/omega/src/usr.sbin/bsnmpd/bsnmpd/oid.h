...
#define OID_freeBSD	2238
#define OIDLEN_freeBSD	7
#define OIDX_freeBSD	{ 7, { 1, 3, 6, 1, 4, 1, 2238, } }
#define OID_freeBSDVersion	4
#define OIDLEN_freeBSDVersion	8
#define OIDX_freeBSDVersion	{ 8, { 1, 3, 6, 1, 4, 1, 2238, 4, } }
