...
const struct cl_option cl_options[] =
{
  ...
  { "-Wtrampolines",
    ...
    N_OPTS, 12, 128,
    CL_COMMON,
    &warn_trampolines, CLVC_BOOLEAN, 0 },
  { "-Wtrigraphs",
  ...
  { "-Wvariable-decl",
    ...
    N_OPTS, 14, 143,
    CL_COMMON,
    &warn_variable_decl, CLVC_BOOLEAN, 0 },
  { "-Wvariadic-macros",
  ...
  { "-fformat-extensions",
    ...
    N_OPTS, 18, 232,
    CL_COMMON | CL_REPORT,
    &flag_format_extensions, CLVC_BOOLEAN, 0 },
  { "-ffreestanding",
  ...
  { "-fnested-functions",
    ...
    N_OPTS, 17, 292,
    CL_C | CL_ObjC,
    &flag_nested_functions, CLVC_BOOLEAN, 0 },
  { "-fnew-abi",
    0,
    N_OPTS, 8, 293,
    CL_CXX | CL_ObjCXX,
  ...
  { "-fstack-protector-strong",
    ...
    N_OPTS, 23, -1,
    CL_COMMON | CL_REJECT_NEGATIVE | CL_REPORT,
    &flag_stack_protect, CLVC_EQUAL, 3 },
  { "-fstats",
